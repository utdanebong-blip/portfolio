...
Master pipelines, not programs. That’s how real 3D artists work.`,coverImage:"https://images.unsplash.com/photo-1558655146-d09347e92766?w=800&h=400&fit=crop",category:"3D Fundamentals",tags:["3d-pipeline","software","beginners","workflow"],publishedAt:"2026-01-26"}],x=[{id:"sr1",videoUrl:"https://vimeo.com/1154646820?fl=ip&fe=ec",title:"Showreel 2025",description:"A short compilation of selected works showcasing modeling, texturing, and lighting.",poster:"showreel-poster.jpg"},{id:"sr2",videoUrl:"https://www.youtube.com/watch?v=dQw4w9WgXcQ",title:"Showreel — Breakdown",description:"Secondary showreel with process breakdowns and behind-the-scenes shots.",poster:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&auto=format&fit=crop&q=60"}],o={about:h,resume:f,contact:y,projects:b,archvizProjects:w,productvizProjects:v,plugins:k,posts:D,showreel:x},j=o.projects||[],A=o.about,S=o.resume,P=o.contact,M=o.plugins||[],C=o.posts||[],z=o.showreel||[],T=o.archvizProjects||[],B=o.productvizProjects||[],p="./";function i(e){if(!e||typeof e!="object")return e;if(Array.isArray(e))return e.map(t=>i(t));const n={},s=t=>{if(!t||typeof t!="string")return!1;const a=t.toLowerCase();return a.startsWith("http")||a.startsWith("mailto:")||a.startsWith("data:")?!1:!!(/[.](png|jpe?g|svg|gif|webp|mp4|webm|glb|gltf|pdf|ico|jpg)$/i.test(a)||a.startsWith("/assets")||a.startsWith("assets/")||/poster|thumb|cover|profile|showreel/i.test(a)&&a.length<64)};for(const t of Object.keys(e)){const a=e[t];if(typeof a=="string"){const c=a,u=c.startsWith(p);if(s(c)&&!u){n[t]=`${p}${c.replace(/^\/?/,"")}`;continue}n[t]=a}else typeof a=="object"&&a!==null?n[t]=i(a):n[t]=a}return n}const V=i(j),U=i(A),I=i(S),R=i(P);i(M);const q=i(C),L=i(z),W=i(T),O=i(B),m=V,E=U,N=I,_=R,G=q,J=L,g=W;let r=O.map(e=>({...e}));const l=[];function F(e,n){const s=r.findIndex(t=>t.id===e);if(s!==-1)return r[s]={...r[s],...n},l.forEach(t=>t(r)),r[s]}function K(){function e(n){return g.find(s=>s.id===n)}return{projects:g,getProject:e}}function Y(){const[e,n]=d.useState(r);d.useEffect(()=>(l.push(n),()=>{const t=l.indexOf(n);t!==-1&&l.splice(t,1)}),[]);function s(t){return e.find(a=>a.id===t)}return{projects:e,getProject:s,updateProject:F}}function Z(e){return G.find(n=>n.id===e)}function $(){function e(n){return m.find(s=>s.id===n)}return{projects:m,getProject:e}}function X(){return{aboutData:E}}function Q(){return{resumeData:N}}export{G as a,g as b,Q as c,Y as d,$ as e,K as f,_ as g,Z as h,r as p,J as s,X as u};
