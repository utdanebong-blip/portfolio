import{j as a}from"./vendor-r3f-C5e-dI0K.js";import{u as v,r as m,L as p}from"./vendor-react-DEhD4NTb.js";import{a as u,X as w}from"./index-BgXBLha6.js";import{b as k,H as x,I as D,U as j,B as A,a as S,A as P,F as M}from"./ArtisticNav-D8evQ44O.js";const h=[{path:"/",label:"Home",icon:x},{path:"/gallery",label:"Gallery",icon:D},{path:"/about",label:"About",icon:j},{path:"/blog",label:"Blog",icon:A},{path:"/contact",label:"Contact",icon:S}];function C(){const e=v(),[n,s]=m.useState(!1);return a.jsxs("header",{className:"fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border",children:[a.jsx("div",{className:"container mx-auto px-4",children:a.jsxs("div",{className:"flex items-center justify-between h-16",children:[a.jsxs(p,{to:"/",className:"flex items-center gap-2 group",children:[a.jsx("div",{className:"w-10 h-10 rounded border border-primary flex items-center justify-center glow-green",children:a.jsx("span",{className:"font-display font-bold text-primary text-lg",children:"UE"})}),a.jsx("span",{className:"font-display text-lg hidden sm:block text-foreground group-hover:text-primary transition-colors",children:"UTIBE EBONG"})]}),a.jsx("nav",{className:"hidden md:flex items-center gap-1",children:h.map(t=>{const i=t.icon,c=e.pathname===t.path;return a.jsxs(p,{to:t.path,className:u("flex items-center gap-2 px-4 py-2 rounded font-body text-sm transition-all duration-300",c?"bg-primary/20 text-primary border border-primary/50":"text-muted-foreground hover:text-foreground hover:bg-secondary"),children:[a.jsx(i,{size:16}),t.label]},t.path)})}),a.jsx("button",{className:"md:hidden p-2 text-foreground hover:text-primary transition-colors",onClick:()=>s(!n),"aria-label":"Toggle menu",children:n?a.jsx(w,{size:24}):a.jsx(k,{size:24})})]})}),n&&a.jsx("nav",{className:"md:hidden absolute top-16 left-0 right-0 bg-background border-b border-border animate-slide-in-up",children:a.jsx("div",{className:"container mx-auto px-4 py-4 flex flex-col gap-2",children:h.map(t=>{const i=t.icon,c=e.pathname===t.path;return a.jsxs(p,{to:t.path,onClick:()=>s(!1),className:u("flex items-center gap-3 px-4 py-3 rounded font-body transition-all",c?"bg-primary/20 text-primary border border-primary/50":"text-muted-foreground hover:text-foreground hover:bg-secondary"),children:[a.jsx(i,{size:20}),t.label]},t.path)})})})]})}function pe({children:e}){return a.jsxs("div",{className:"min-h-screen flex flex-col bg-background",children:[a.jsx("div",{className:"hidden lg:block",children:a.jsx(P,{})}),a.jsx("div",{className:"lg:hidden",children:a.jsx(C,{})}),a.jsx("main",{className:"flex-1 pt-20",children:e}),a.jsx(M,{})]})}const z={bio:`Professional 3D Artist with over 6 years of experience creating high quality game ready props, architectural visualizations, and product renders. Skilled in building production ready assets, leading small teams, and delivering visuals that balance technical accuracy with strong visual storytelling.
...
Think long-term. Invest in your craft. The career will follow.`,coverImage:"https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=400&fit=crop",category:"Career",tags:["3d-career","jobs","beginners","mindset"],publishedAt:"2026-01-26"}],R=[{id:"sr1",videoUrl:"https://vimeo.com/1154646820?fl=ip&fe=ec",title:"Showreel 2025",description:"A short compilation of selected works showcasing modeling, texturing, and lighting.",poster:"showreel-poster.jpg"},{id:"sr2",videoUrl:"https://www.youtube.com/watch?v=dQw4w9WgXcQ",title:"Showreel — Breakdown",description:"Secondary showreel with process breakdowns and behind-the-scenes shots.",poster:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&auto=format&fit=crop&q=60"}],r={about:z,resume:T,contact:B,projects:V,archvizProjects:U,productvizProjects:I,plugins:L,posts:q,showreel:R},W=r.projects||[],N=r.about,E=r.resume,O=r.contact,G=r.plugins||[],F=r.posts||[],H=r.showreel||[],_=r.archvizProjects||[],J=r.productvizProjects||[],f="./";function o(e){if(!e||typeof e!="object")return e;if(Array.isArray(e))return e.map(s=>o(s));const n=Array.isArray(e)?[]:{};for(const s of Object.keys(e)){const t=e[s];if(typeof t=="string"){const i=t,c=i.startsWith("http")||i.startsWith("mailto:")||i.startsWith("data:"),b=i.startsWith(f);if(!c&&!b){n[s]=`${f}${i.replace(/^\/?/,"")}`;continue}n[s]=t}else typeof t=="object"&&t!==null?n[s]=o(t):n[s]=t}return n}const K=o(W),$=o(N),Y=o(E),Z=o(O),Q=o(G),X=o(F),ee=o(H),te=o(_),ae=o(J),g=K,ne=$,se=Y,me=Z,ge=Q,ie=X,ue=ee,y=te;let l=ae.map(e=>({...e}));const d=[];function oe(e,n){const s=l.findIndex(t=>t.id===e);if(s!==-1)return l[s]={...l[s],...n},d.forEach(t=>t(l)),l[s]}function he(){function e(n){return y.find(s=>s.id===n)}return{projects:y,getProject:e}}function fe(){const[e,n]=m.useState(l);m.useEffect(()=>(d.push(n),()=>{const t=d.indexOf(n);t!==-1&&d.splice(t,1)}),[]);function s(t){return e.find(i=>i.id===t)}return{projects:e,getProject:s,updateProject:oe}}function ye(e){return g.find(n=>n.id===e)}function be(e){return ie.find(n=>n.id===e)}function ve(){function e(n){return g.find(s=>s.id===n)}return{projects:g,getProject:e}}function we(){return{aboutData:ne}}function ke(){return{resumeData:se}}export{pe as L,ie as a,y as b,l as c,ge as d,ke as e,fe as f,ve as g,he as h,ye as i,me as j,be as k,g as p,ue as s,we as u};
