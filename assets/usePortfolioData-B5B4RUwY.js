import{j as e}from"./vendor-r3f-C5e-dI0K.js";import{u as f,r as p,L as d}from"./vendor-react-DEhD4NTb.js";import{a as g,X as y}from"./index-BcmFK3C3.js";import{b,H as v,I as w,U as k,B as x,a as D,A as j,F as S}from"./ArtisticNav-BMRw127S.js";const u=[{path:"/",label:"Home",icon:v},{path:"/gallery",label:"Gallery",icon:w},{path:"/about",label:"About",icon:k},{path:"/blog",label:"Blog",icon:x},{path:"/contact",label:"Contact",icon:D}];function A(){const a=f(),[n,s]=p.useState(!1);return e.jsxs("header",{className:"fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border",children:[e.jsx("div",{className:"container mx-auto px-4",children:e.jsxs("div",{className:"flex items-center justify-between h-16",children:[e.jsxs(d,{to:"/",className:"flex items-center gap-2 group",children:[e.jsx("div",{className:"w-10 h-10 rounded border border-primary flex items-center justify-center glow-green",children:e.jsx("span",{className:"font-display font-bold text-primary text-lg",children:"UE"})}),e.jsx("span",{className:"font-display text-lg hidden sm:block text-foreground group-hover:text-primary transition-colors",children:"UTIBE EBONG"})]}),e.jsx("nav",{className:"hidden md:flex items-center gap-1",children:u.map(t=>{const r=t.icon,c=a.pathname===t.path;return e.jsxs(d,{to:t.path,className:g("flex items-center gap-2 px-4 py-2 rounded font-body text-sm transition-all duration-300",c?"bg-primary/20 text-primary border border-primary/50":"text-muted-foreground hover:text-foreground hover:bg-secondary"),children:[e.jsx(r,{size:16}),t.label]},t.path)})}),e.jsx("button",{className:"md:hidden p-2 text-foreground hover:text-primary transition-colors",onClick:()=>s(!n),"aria-label":"Toggle menu",children:n?e.jsx(y,{size:24}):e.jsx(b,{size:24})})]})}),n&&e.jsx("nav",{className:"md:hidden absolute top-16 left-0 right-0 bg-background border-b border-border animate-slide-in-up",children:e.jsx("div",{className:"container mx-auto px-4 py-4 flex flex-col gap-2",children:u.map(t=>{const r=t.icon,c=a.pathname===t.path;return e.jsxs(d,{to:t.path,onClick:()=>s(!1),className:g("flex items-center gap-3 px-4 py-3 rounded font-body transition-all",c?"bg-primary/20 text-primary border border-primary/50":"text-muted-foreground hover:text-foreground hover:bg-secondary"),children:[e.jsx(r,{size:20}),t.label]},t.path)})})})]})}function $({children:a}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-background",children:[e.jsx("div",{className:"hidden lg:block",children:e.jsx(j,{})}),e.jsx("div",{className:"lg:hidden",children:e.jsx(A,{})}),e.jsx("main",{className:"flex-1 pt-20",children:a}),e.jsx(S,{})]})}const M={bio:`Professional 3D Artist with over 6 years of experience creating high quality game ready props, architectural visualizations, and product renders. Skilled in building production ready assets, leading small teams, and delivering visuals that balance technical accuracy with strong visual storytelling.
...
Think long-term. Invest in your craft. The career will follow.`,coverImage:"https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&h=400&fit=crop",category:"Career",tags:["3d-career","jobs","beginners","mindset"],publishedAt:"2026-01-26"}],I=[{id:"sr1",videoUrl:"https://vimeo.com/1154646820?fl=ip&fe=ec",title:"Showreel 2025",description:"A short compilation of selected works showcasing modeling, texturing, and lighting.",poster:"showreel-poster.jpg"},{id:"sr2",videoUrl:"https://www.youtube.com/watch?v=dQw4w9WgXcQ",title:"Showreel — Breakdown",description:"Secondary showreel with process breakdowns and behind-the-scenes shots.",poster:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&auto=format&fit=crop&q=60"}],i={about:M,resume:P,contact:C,projects:z,archvizProjects:T,productvizProjects:B,plugins:U,posts:V,showreel:I},L=i.projects||[],q=i.about,R=i.resume,N=i.contact,W=i.plugins||[],O=i.posts||[],E=i.showreel||[],G=i.archvizProjects||[],F=i.productvizProjects||[],m=L,H=q,J=R,ee=N,te=W,_=O,ae=E,h=G;let o=F.map(a=>({...a}));const l=[];function K(a,n){const s=o.findIndex(t=>t.id===a);if(s!==-1)return o[s]={...o[s],...n},l.forEach(t=>t(o)),o[s]}function ne(){function a(n){return h.find(s=>s.id===n)}return{projects:h,getProject:a}}function se(){const[a,n]=p.useState(o);p.useEffect(()=>(l.push(n),()=>{const t=l.indexOf(n);t!==-1&&l.splice(t,1)}),[]);function s(t){return a.find(r=>r.id===t)}return{projects:a,getProject:s,updateProject:K}}function ie(a){return m.find(n=>n.id===a)}function oe(a){return _.find(n=>n.id===a)}function re(){function a(n){return m.find(s=>s.id===n)}return{projects:m,getProject:a}}function le(){return{aboutData:H}}function ce(){return{resumeData:J}}export{$ as L,te as a,m as b,h as c,ce as d,se as e,re as f,ne as g,ie as h,ee as i,_ as j,oe as k,o as p,ae as s,le as u};
